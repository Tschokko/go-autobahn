...
func CreateServerCertificate(cn string, validTo time.Time, certFilename, keyFilename, caCertFilename, caKeyFilename string) error {
	// Load CA
	...
	cert := &x509.Certificate{
		...
		KeyUsage:              x509.KeyUsageDigitalSignature | x509.KeyUsageKeyEncipherment | x509.KeyUsageContentCommitment | x509.KeyUsageKeyAgreement,
		IsCA:                  false,
